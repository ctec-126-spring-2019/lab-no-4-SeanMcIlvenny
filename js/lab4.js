...
function title() {
    let output = "---Jolene---<br>Cover by The White Stripes<br><br>";
    return output;
}
...
function chorus2() {
    ...
    let output = "Well I could easily understand <br> How you could easily take my man <br> But you don't know what he means to me, Jolene <br><br>";
    return output;
}
